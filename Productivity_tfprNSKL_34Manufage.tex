...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  ...
  \hline
Min & -3.64 & 0.44 & 0.55 & -3.14 & 0.59 & 0.90 & -2.90 & 0.40 & 0.30 &  \\ 
  Max & 1.33 & 0.89 & 1.35 & 0.09 & 1.02 & 1.62 & -0.60 & 0.68 & 0.73 &  \\ 
  Mean & -1.04 & 0.68 & 1.00 & -1.64 & 0.77 & 1.16 & -1.75 & 0.54 & 0.51 &  \\ 
  Median & -0.92 & 0.69 & 1.06 & -1.87 & 0.70 & 0.96 & -1.75 & 0.54 & 0.51 &  \\ 
  Stdev & 2.20 & 0.19 & 0.39 & 1.63 & 0.22 & 0.40 & 1.62 & 0.20 & 0.31 &  \\ 
  IQR & 2.79 & 0.21 & 0.58 & 1.61 & 0.21 & 0.36 & 1.15 & 0.14 & 0.22 &  \\ 
  \end{tabular}
}
...
Upper middle income & 0.72 & 0.76 & 0.95 & --- & --- & --- & --- & --- & --- &  \\ 
  NA & --- & --- & --- & --- & --- & --- & --- & --- & --- &  \\ 
  NA.1 & --- & --- & --- & --- & --- & --- & --- & --- & --- &  \\ 
  Lower middle income & -2.8 & 0.6 & 1.06 & -2.5 & 0.8 & 1.29 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  & median\_.20 & sd\_.20 & iqr\_.20 & median\_11.20 & sd\_11.20 & iqr\_11.20 & median\_0.10 & sd\_0.10 & iqr\_0.10 &  \\ 
  \hline
East Asia and Pacific & 0.12 & 0.89 & 1.35 & 0.09 & 0.7 & 0.9 & -0.6 & 0.4 & 0.3 &  \\ 
  Latin America and Caribbean & 1.33 & 0.62 & 0.55 & --- & --- & --- & --- & --- & --- &  \\ 
  South Asia & -2.80 & 0.60 & 1.06 & -2.5 & 0.8 & 1.29 & --- & --- & --- &  \\ 
  \end{tabular}
}
