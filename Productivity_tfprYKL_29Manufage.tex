...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  ...
  \hline
Min & -1.38 & 0.09 & 0.00 & -0.82 & 0.01 & 0.02 & -1.01 & 0.38 & 0.01 &  \\ 
  Max & 3.32 & 1.05 & 1.32 & 3.04 & 4.09 & 7.16 & 2.68 & 0.93 & 1.45 &  \\ 
  Mean & 0.44 & 0.61 & 0.79 & 0.84 & 0.98 & 1.41 & 0.34 & 0.67 & 0.76 &  \\ 
  Median & -0.18 & 0.59 & 0.88 & 0.13 & 0.84 & 1.04 & 0.03 & 0.72 & 0.76 &  \\ 
  Stdev & 1.56 & 0.29 & 0.41 & 1.41 & 0.90 & 1.70 & 1.17 & 0.22 & 0.47 &  \\ 
  IQR & 1.45 & 0.34 & 0.47 & 2.62 & 0.41 & 0.63 & 0.70 & 0.35 & 0.53 &  \\ 
  \end{tabular}
}
...
Lower middle income & --- & --- & --- & -0.02 & 0.86 & 1.2 & --- & --- & --- &  \\ 
  ...
  NA & --- & --- & --- & --- & --- & --- & --- & --- & --- &  \\ 
  High income & 2.92 & 0.68 & 0.88 & 2.68 & 0.43 & 0.46 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:34:16 2016
{\footnotesize
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  & median\_.20 & sd\_.20 & iqr\_.20 & median\_11.20 & sd\_11.20 & iqr\_11.20 & median\_0.10 & sd\_0.10 & iqr\_0.10 &  \\ 
  \hline
East Asia and Pacific & --- & --- & --- & 0.04 & 0.88 & 1.07 & --- & --- & --- &  \\ 
  Europe and Central Asia & 1.07 & 0.69 & 0.9 & 2.63 & 1.13 & 2.03 & --- & --- & --- &  \\ 
  Latin America and Caribbean & -0.29 & 0.56 & 0.76 & --- & --- & --- & --- & --- & --- &  \\ 
  Middle East and North Africa & --- & --- & --- & 1.67 & 1.4 & 2.28 & 0.83 & 0.82 & 0.76 &  \\ 
  South Asia & 0.07 & 0.78 & 1.14 & -0.01 & 0.76 & 0.86 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & -0.19 & 0.61 & 1 & -0.59 & 0.75 & 1.06 & --- & --- & --- &  \\ 
  \end{tabular}
}
