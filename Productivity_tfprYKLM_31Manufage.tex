...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  &   & 0 to 10 &   &   & 11 to 20 &   &   & more than 20 &   &   \\ 
   ...
   \hline
Min & 1.27 & 0.08 & 0 & 1.41 & 0.37 & 0.38 & 1.21 & 0.25 & 0.28 &  \\ 
  Max & 1.56 & 0.5 & 0.62 & 2.45 & 1.42 & 1.98 & 1.68 & 1.26 & 1.48 &  \\ 
  Mean & 1.44 & 0.29 & 0.3 & 1.78 & 0.67 & 0.95 & 1.46 & 0.63 & 0.72 &  \\ 
  Median & 1.47 & 0.28 & 0.29 & 1.64 & 0.45 & 0.73 & 1.47 & 0.5 & 0.55 &  \\ 
  Stdev & 0.14 & 0.19 & 0.31 & 0.46 & 0.5 & 0.75 & 0.2 & 0.44 & 0.53 &  \\ 
  IQR & 0.17 & 0.26 & 0.48 & 0.28 & 0.29 & 0.87 & 0.22 & 0.27 & 0.37 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  &   & 0 to 10 &   &   & 11 to 20 &   &   & more than 20 &   &   \\ 
   ...
   \hline
Lower middle income & --- & --- & --- & --- & --- & --- & --- & --- & --- &  \\ 
  Upper middle income & 1.56 & 0.08 & 0.08 & 1.65 & 0.37 & 0.38 & 1.68 & 0.52 & 0.6 &  \\ 
  NA & --- & --- & --- & --- & --- & --- & --- & --- & --- &  \\ 
  High income & 1.53 & 0.38 & 0.62 & 1.62 & 0.47 & 1.04 & 1.54 & 0.25 & 0.28 &  \\ 
  \end{tabular}
}
...
East Asia and Pacific & --- & --- & --- & 2.05 & 0.89 & 1.18 & 1.44 & 0.89 & 1.04 &  \\ 
  Europe and Central Asia & 1.53 & 0.38 & 0.62 & 1.62 & 0.47 & 1.04 & 1.54 & 0.25 & 0.28 &  \\ 
  Middle East and North Africa & 1.27 & 0.18 & 0 & --- & --- & --- & --- & --- & --- &  \\ 
  South Asia & 1.4 & 0.5 & 0.51 & 1.41 & 0.43 & 0.41 & 1.41 & 0.49 & 0.51 &  \\ 
  \end{tabular}
}
