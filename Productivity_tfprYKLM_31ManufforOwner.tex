...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 2.49 & 1.04 & 0.6 & 1.25 & 0.32 & 0.01 &  \\ 
  Max & 2.49 & 1.04 & 0.6 & 1.65 & 1.27 & 1.48 &  \\ 
  Mean & 2.49 & 1.04 & 0.6 & 1.43 & 0.56 & 0.61 &  \\ 
  Median & 2.49 & 1.04 & 0.6 & 1.41 & 0.39 & 0.58 &  \\ 
  Stdev & --- & --- & --- & 0.17 & 0.4 & 0.54 &  \\ 
  IQR & 0 & 0 & 0 & 0.24 & 0.1 & 0.22 &  \\ 
  \end{tabular}
