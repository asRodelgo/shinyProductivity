...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   ...
   \hline
Min & 0.56 & 0.3 & 0.01 & 0.99 & 0.15 & 0 &  \\ 
  Max & 6.78 & 1.9 & 3.46 & 9.96 & 3.71 & 5.36 &  \\ 
  Mean & 2.42 & 0.89 & 1.19 & 2.77 & 1.01 & 1.34 &  \\ 
  Median & 2.03 & 0.84 & 0.9 & 2.53 & 0.98 & 1.08 &  \\ 
  Stdev & 1.34 & 0.32 & 0.76 & 1.96 & 0.8 & 1.22 &  \\ 
  IQR & 0.64 & 0.26 & 0.76 & 1.09 & 0.4 & 0.7 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:01:21 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Lower middle income & 2.04 & 0.94 & 0.92 & --- & --- & --- &  \\ 
  Upper middle income & --- & --- & --- & 1.94 & 0.7 & 0.83 &  \\ 
  NA & --- & --- & --- & --- & --- & --- &  \\ 
  High income & 5.76 & 0.99 & 1.43 & --- & --- & --- &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & 2.07 & 0.8 & 1 & --- & --- & --- &  \\ 
  Europe and Central Asia & 2.53 & 0.96 & 1.51 & --- & --- & --- &  \\ 
  Latin America and Caribbean & --- & --- & --- & 2.31 & 0.8 & 1.01 &  \\ 
  Middle East and North Africa & 2.03 & 0.79 & 0.89 & --- & --- & --- &  \\ 
  South Asia & 2.08 & 0.83 & 0.89 & 2.69 & 1.04 & 1.22 &  \\ 
  Sub-Saharan Africa & 2.05 & 0.97 & 1.22 & 2.35 & 0.75 & 1.01 &  \\ 
  \end{tabular}
