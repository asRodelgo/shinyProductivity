...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  ...
  \hline
Min & -1.04 & 0.35 & 0.44 & 0.74 & 0.05 & 0.07 & 0.86 & 0.11 & 0.16 &  \\ 
  Max & 7.33 & 1.76 & 2.61 & 8.31 & 1.10 & 1.59 & 7.56 & 2.23 & 4.35 &  \\ 
  Mean & 2.05 & 0.81 & 1.12 & 3.12 & 0.63 & 0.84 & 2.55 & 0.95 & 1.38 &  \\ 
  Median & 1.30 & 0.79 & 1.03 & 1.80 & 0.65 & 1.01 & 1.81 & 0.88 & 1.22 &  \\ 
  Stdev & 2.27 & 0.33 & 0.52 & 2.60 & 0.30 & 0.49 & 2.16 & 0.44 & 0.94 &  \\ 
  IQR & 1.00 & 0.37 & 0.66 & 2.15 & 0.45 & 0.82 & 1.01 & 0.40 & 0.81 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  & median\_Small.firms & sd\_Small.firms & iqr\_Small.firms & median\_Large.firms & sd\_Large.firms & iqr\_Large.firms & median\_Medium.firms & sd\_Medium.firms & iqr\_Medium.firms &  \\ 
  \hline
East Asia and Pacific & 1.12 & 0.58 & 0.68 & 1.84 & 0.67 & 0.87 & 1.97 & 1.01 & 1.52 &  \\ 
  Europe and Central Asia & 5.6 & 0.78 & 1.03 & --- & --- & --- & 6.16 & 0.84 & 0.79 &  \\ 
  Latin America and Caribbean & 1.11 & 0.8 & 1.08 & 1.63 & 0.68 & 1.04 & 1.33 & 0.81 & 1.1 &  \\ 
