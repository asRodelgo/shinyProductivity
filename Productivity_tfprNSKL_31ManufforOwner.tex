...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & -3.42 & 0.54 & 0.54 & -1.87 & 1.68 & 2.02 &  \\ 
  Max & -0.65 & 1.60 & 2.57 & -1.87 & 1.68 & 2.02 &  \\ 
  Mean & -2.19 & 1.03 & 1.45 & -1.87 & 1.68 & 2.02 &  \\ 
  Median & -2.35 & 0.92 & 1.06 & -1.87 & 1.68 & 2.02 &  \\ 
  Stdev & 1.20 & 0.46 & 0.84 & --- & --- & --- &  \\ 
  IQR & 1.91 & 0.75 & 1.06 & 0 & 0 & 0 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Lower middle income & -3.21 & 1.42 & 2.08 & --- & --- & --- &  \\ 
  Upper middle income & -0.65 & 0.54 & 0.54 & --- & --- & --- &  \\ 
  NA & --- & --- & --- & --- & --- & --- &  \\ 
  High income & -2.35 & 0.67 & 1.02 & --- & --- & --- &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:46:05 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & -1.93 & 0.98 & 1.55 & --- & --- & --- &  \\ 
  Europe and Central Asia & -2.35 & 0.67 & 1.02 & --- & --- & --- &  \\ 
  Middle East and North Africa & -1.30 & 1.60 & 2.08 & --- & --- & --- &  \\ 
  South Asia & -3.42 & 0.92 & 1.06 & --- & --- & --- &  \\ 
  \end{tabular}
