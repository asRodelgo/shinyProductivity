...
\begin{minipage}[t]{0.99\textwidth} % top section
  \vspace{-0.5cm}
      ...
      \subsection*{\color{white!40!black}Indicator: \color{blue!40!black}Total factor productivity YKL}
...
Min & 1.19 & 0.12 & 0.15 &  \\ 
  Max & 5.66 & 3.30 & 5.91 &  \\ 
  Mean & 2.38 & 1.15 & 1.54 &  \\ 
  Median & 2.31 & 1.11 & 1.44 &  \\ 
  Stdev & 0.67 & 0.60 & 0.93 &  \\ 
  IQR & 0.61 & 0.72 & 0.93 &  \\ 
  \end{tabular}
...
\begin{tabular}{lrrrl}
  & median & sd & iqr &  \\ 
  \hline
Low income & 2.11 & 1.91 & 1.93 &  \\ 
  Lower middle income & 2.55 & 1.15 & 1.44 &  \\ 
  Upper middle income & 2.18 & 0.84 & 1.31 &  \\ 
  High income & 2.03 & 0.95 & 1.17 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 20:51:25 2016
\begin{tabular}{lrrrl}
  & median & sd & iqr &  \\ 
  \hline
East Asia and Pacific & 2.41 & 1.54 & 1.85 &  \\ 
  Europe and Central Asia & 2.41 & 1.01 & 1.61 &  \\ 
  Latin America and Caribbean & 2.11 & 0.68 & 0.91 &  \\ 
  Middle East and North Africa & 2.35 & 1.03 & 1.36 &  \\ 
  South Asia & 2.67 & 1.35 & 1.72 &  \\ 
  Sub-Saharan Africa & 2.32 & 1.25 & 1.69 &  \\ 
  \end{tabular}
