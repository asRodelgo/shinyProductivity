...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & -6.75 & 0.40 & 0.59 & -6.86 & 0.27 & 0.09 &  \\ 
  Max & 1.22 & 3.44 & 4.56 & 1.83 & 1.05 & 1.28 &  \\ 
  Mean & -2.16 & 0.96 & 1.16 & -0.37 & 0.67 & 0.67 &  \\ 
  Median & -1.50 & 0.76 & 0.79 & 0.50 & 0.60 & 0.66 &  \\ 
  Stdev & 2.66 & 0.77 & 1.05 & 3.25 & 0.28 & 0.38 &  \\ 
  IQR & 3.52 & 0.28 & 0.47 & 1.15 & 0.26 & 0.22 &  \\ 
  \end{tabular}
...
Low income & -6.74 & 0.96 & 0.84 & --- & --- & --- &  \\ 
  Lower middle income & -1.38 & 0.83 & 1.00 & --- & --- & --- &  \\ 
  Upper middle income & -0.75 & 0.76 & 0.72 & --- & --- & --- &  \\ 
  High income & -0.90 & 0.52 & 0.73 & 0.18 & 0.57 & 0.81 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & -1.27 & 0.40 & 0.68 & --- & --- & --- &  \\ 
  Europe and Central Asia & -0.90 & 0.52 & 0.73 & 0.18 & 0.57 & 0.81 &  \\ 
  Latin America and Caribbean & 0.24 & 0.73 & 0.75 & 1 & 0.77 & 0.95 &  \\ 
  Middle East and North Africa & -2.03 & 0.76 & 0.70 & --- & --- & --- &  \\ 
