...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & -6.86 & 0.27 & 0.09 & -6.75 & 0.4 & 0.59 &  \\ 
  Max & 1.83 & 1.05 & 1.28 & 1.22 & 3.44 & 4.56 &  \\ 
  Mean & -0.37 & 0.67 & 0.67 & -2.16 & 0.96 & 1.16 &  \\ 
  Median & 0.5 & 0.6 & 0.66 & -1.5 & 0.76 & 0.79 &  \\ 
  Stdev & 3.25 & 0.28 & 0.38 & 2.66 & 0.77 & 1.05 &  \\ 
  IQR & 1.15 & 0.26 & 0.22 & 3.52 & 0.28 & 0.47 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:06:34 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Low income & --- & --- & --- & -6.74 & 0.96 & 0.84 &  \\ 
  Lower middle income & --- & --- & --- & -1.38 & 0.83 & 1 &  \\ 
  Upper middle income & --- & --- & --- & -0.75 & 0.76 & 0.72 &  \\ 
  High income & 0.18 & 0.57 & 0.81 & -0.9 & 0.52 & 0.73 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:06:35 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & --- & --- & --- & -1.27 & 0.4 & 0.68 &  \\ 
  Europe and Central Asia & 0.18 & 0.57 & 0.81 & -0.9 & 0.52 & 0.73 &  \\ 
  Latin America and Caribbean & 1 & 0.77 & 0.95 & 0.24 & 0.73 & 0.75 &  \\ 
  Middle East and North Africa & --- & --- & --- & -2.03 & 0.76 & 0.7 &  \\ 
  South Asia & --- & --- & --- & -2.11 & 0.68 & 0.77 &  \\ 
  Sub-Saharan Africa & --- & --- & --- & -4.12 & 1.02 & 1.34 &  \\ 
  \end{tabular}
