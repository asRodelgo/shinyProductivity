...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in names(sumStats) <- rep(c("{}median"{}, "{}sd"{}, "{}IQR"{}), 2): 'names' attribute [6] must be the same length as the vector [3]}}\end{kframe}
      \vspace*{0.5cm}
    \end{minipage}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `[.data.frame`(dataPlot, , colOrder): undefined columns selected}}\end{kframe}
      \vspace*{0.5cm}
    \end{minipage}
%\end{minipage}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `[.data.frame`(incomeStats, , reorder): undefined columns selected}}\end{kframe}
      \vspace*{0.5cm}
    \end{minipage}
%\end{minipage}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `[.data.frame`(regionStats, , reorder): undefined columns selected}}\end{kframe}
      \vspace*{0.5cm}
    \end{minipage}
%\end{minipage}
