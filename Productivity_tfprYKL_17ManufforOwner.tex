...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 1.6 & 0.22 & 0.31 & 1.55 & 0.19 & 0.09 &  \\ 
  Max & 3.51 & 2.74 & 3.87 & 2.64 & 2.2 & 2.89 &  \\ 
  Mean & 2.18 & 0.98 & 1.31 & 2.01 & 0.8 & 1.01 &  \\ 
  Median & 1.9 & 0.7 & 0.75 & 1.95 & 0.76 & 0.92 &  \\ 
  Stdev & 0.61 & 0.84 & 1.38 & 0.35 & 0.39 & 0.54 &  \\ 
  IQR & 0.7 & 0.68 & 0.75 & 0.59 & 0.27 & 0.43 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Low income & --- & --- & --- & 2.1 & 0.57 & 0.77 &  \\ 
  Lower middle income & --- & --- & --- & 2.07 & 0.75 & 0.99 &  \\ 
  Upper middle income & --- & --- & --- & 1.74 & 0.78 & 0.8 &  \\ 
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:03:56 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & 1.9 & 1.2 & 1.28 & 2.1 & 0.59 & 0.74 &  \\ 
  Europe and Central Asia & --- & --- & --- & 1.56 & 0.88 & 0.8 &  \\ 
  Latin America and Caribbean & --- & --- & --- & 1.85 & 0.72 & 0.95 &  \\ 
  Middle East and North Africa & --- & --- & --- & 1.81 & 0.76 & 0.82 &  \\ 
  South Asia & --- & --- & --- & 2.53 & 0.82 & 1.17 &  \\ 
  Sub-Saharan Africa & 1.74 & 0.67 & 0.87 & 2 & 0.88 & 0.92 &  \\ 
  \end{tabular}
