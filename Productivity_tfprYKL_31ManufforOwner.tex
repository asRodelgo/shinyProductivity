...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 2.79 & 2.01 & 3.73 & 1.88 & 0.31 & 0.1 &  \\ 
  Max & 2.79 & 2.01 & 3.73 & 2.51 & 1.59 & 2.09 &  \\ 
  Mean & 2.79 & 2.01 & 3.73 & 2.23 & 0.88 & 1.22 &  \\ 
  Median & 2.79 & 2.01 & 3.73 & 2.24 & 0.84 & 1.26 &  \\ 
  Stdev & --- & --- & --- & 0.26 & 0.45 & 0.81 &  \\ 
  IQR & 0 & 0 & 0 & 0.42 & 0.47 & 1.2 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:04:37 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Lower middle income & --- & --- & --- & 2.02 & 1.12 & 1.94 &  \\ 
  Upper middle income & --- & --- & --- & 2.43 & 0.43 & 0.37 &  \\ 
  NA & --- & --- & --- & --- & --- & --- &  \\ 
  High income & --- & --- & --- & 2.51 & 0.74 & 0.81 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:04:38 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & --- & --- & --- & 2.18 & 0.84 & 1.29 &  \\ 
  Europe and Central Asia & --- & --- & --- & 2.51 & 0.74 & 0.81 &  \\ 
  Latin America and Caribbean & --- & --- & --- & 2.5 & 0.31 & 0.1 &  \\ 
  Middle East and North Africa & --- & --- & --- & 1.88 & 1.59 & 2.09 &  \\ 
  South Asia & --- & --- & --- & 2.12 & 0.94 & 1.72 &  \\ 
  \end{tabular}
