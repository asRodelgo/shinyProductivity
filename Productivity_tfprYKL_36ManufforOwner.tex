...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & -0.14 & 0.37 & 0.40 & 0.18 & 0.11 & 0.16 &  \\ 
  Max & 3.18 & 3.65 & 4.87 & 5.41 & 2.44 & 3.11 &  \\ 
  Mean & 2.04 & 0.95 & 1.24 & 2.36 & 0.85 & 0.96 &  \\ 
  Median & 2.42 & 0.75 & 0.96 & 2.31 & 0.80 & 0.68 &  \\ 
  Stdev & 1.05 & 0.77 & 1.07 & 1.79 & 0.78 & 1.03 &  \\ 
  IQR & 1.11 & 0.24 & 0.47 & 2.13 & 0.52 & 0.75 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Low income & 0.54 & 0.87 & 0.74 & --- & --- & --- &  \\ 
  Lower middle income & 2.64 & 0.85 & 1.11 & --- & --- & --- &  \\ 
  Upper middle income & 2.20 & 0.68 & 0.74 & --- & --- & --- &  \\ 
  High income & -0.14 & 0.37 & 0.40 & 0.62 & 0.11 & 0.16 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & 2.42 & 0.65 & 1.05 & --- & --- & --- &  \\ 
  Europe and Central Asia & -0.14 & 0.37 & 0.40 & 0.62 & 0.11 & 0.16 &  \\ 
  Latin America and Caribbean & 2.19 & 0.62 & 0.62 & 2.67 & 0.8 & 1 &  \\ 
  Middle East and North Africa & 2.69 & 0.79 & 1.03 & --- & --- & --- &  \\ 
  South Asia & 2.58 & 0.83 & 0.96 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & 2.85 & 0.98 & 1.69 & --- & --- & --- &  \\ 
  \end{tabular}
