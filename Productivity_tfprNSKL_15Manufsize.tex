...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  ...
  \hline
Min & -6.94 & 0.01 & 0.00 & -7.51 & 0.06 & 0.00 & -7.08 & 0.10 & 0.14 &  \\ 
  Max & 2.67 & 4.57 & 3.55 & 2.94 & 5.17 & 8.17 & 2.45 & 4.72 & 5.21 &  \\ 
  Mean & -1.32 & 0.90 & 1.18 & -1.42 & 0.97 & 1.32 & -1.73 & 0.93 & 1.18 &  \\ 
  Median & -1.35 & 0.76 & 1.06 & -0.71 & 0.92 & 1.05 & -1.42 & 0.75 & 1.01 &  \\ 
  Stdev & 2.71 & 0.69 & 0.85 & 2.73 & 0.77 & 1.31 & 2.67 & 0.70 & 0.92 &  \\ 
  IQR & 3.64 & 0.54 & 0.92 & 4.13 & 0.55 & 1.01 & 4.53 & 0.39 & 0.63 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  ...
  \hline
Low income & -5.62 & 0.74 & 1.32 & -5.2 & 1.65 & 1.78 & -4.87 & 0.65 & 1 &  \\ 
  Lower middle income & --- & --- & --- & -0.94 & 0.97 & 1.31 & --- & --- & --- &  \\ 
  Upper middle income & --- & --- & --- & --- & --- & --- & --- & --- & --- &  \\ 
  High income & --- & --- & --- & -0.31 & 0.7 & 0.55 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:39:02 2016
{\footnotesize
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  & median\_Large.firms & sd\_Large.firms & iqr\_Large.firms & median\_Medium.firms & sd\_Medium.firms & iqr\_Medium.firms & median\_Small.firms & sd\_Small.firms & iqr\_Small.firms &  \\ 
  \hline
East Asia and Pacific & -3.09 & 1.09 & 1.83 & -3.61 & 1.14 & 1.27 & -4.42 & 0.62 & 0.56 &  \\ 
  Europe and Central Asia & --- & --- & --- & --- & --- & --- & --- & --- & --- &  \\ 
  Latin America and Caribbean & --- & --- & --- & -0.28 & 0.62 & 0.71 & --- & --- & --- &  \\ 
  Middle East and North Africa & --- & --- & --- & -0.14 & 0.97 & 0.96 & -0.06 & 0.83 & 1.11 &  \\ 
  South Asia & -1.81 & 1.19 & 1.4 & -2.35 & 1.12 & 1.19 & -2.41 & 0.94 & 1.17 &  \\ 
  Sub-Saharan Africa & --- & --- & --- & -3.3 & 1.36 & 1.78 & -3.95 & 1.05 & 1.51 &  \\ 
  \end{tabular}
}
