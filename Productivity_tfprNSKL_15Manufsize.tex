...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  &   & Small firms &   &   & Medium firms &   &   & Large firms &   &   \\ 
   ...
   \hline
Min & -7.08 & 0.1 & 0.14 & -7.51 & 0.06 & 0 & -6.94 & 0.01 & 0 &  \\ 
  Max & 2.45 & 4.72 & 5.21 & 2.94 & 5.17 & 8.17 & 2.67 & 4.57 & 3.55 &  \\ 
  Mean & -1.73 & 0.93 & 1.18 & -1.42 & 0.97 & 1.32 & -1.32 & 0.9 & 1.18 &  \\ 
  Median & -1.42 & 0.75 & 1.01 & -0.71 & 0.92 & 1.05 & -1.35 & 0.76 & 1.06 &  \\ 
  Stdev & 2.67 & 0.7 & 0.92 & 2.73 & 0.77 & 1.31 & 2.71 & 0.69 & 0.85 &  \\ 
  IQR & 4.53 & 0.39 & 0.63 & 4.13 & 0.55 & 1.01 & 3.64 & 0.54 & 0.92 &  \\ 
  \end{tabular}
}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 20:59:35 2016
{\footnotesize
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  &   & Small firms &   &   & Medium firms &   &   & Large firms &   &   \\ 
   & median & sd & IQR & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Low income & -4.87 & 0.65 & 1 & -5.2 & 1.65 & 1.78 & -5.62 & 0.74 & 1.32 &  \\ 
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 20:59:36 2016
{\footnotesize
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  &   & Small firms &   &   & Medium firms &   &   & Large firms &   &   \\ 
   & median & sd & IQR & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & -4.42 & 0.62 & 0.56 & -3.61 & 1.14 & 1.27 & -3.09 & 1.09 & 1.83 &  \\ 
  Europe and Central Asia & --- & --- & --- & --- & --- & --- & --- & --- & --- &  \\ 
  Latin America and Caribbean & --- & --- & --- & -0.28 & 0.62 & 0.71 & --- & --- & --- &  \\ 
  Middle East and North Africa & -0.06 & 0.83 & 1.11 & -0.14 & 0.97 & 0.96 & --- & --- & --- &  \\ 
  South Asia & -2.41 & 0.94 & 1.17 & -2.35 & 1.12 & 1.19 & -1.81 & 1.19 & 1.4 &  \\ 
  Sub-Saharan Africa & -3.95 & 1.05 & 1.51 & -3.3 & 1.36 & 1.78 & --- & --- & --- &  \\ 
  \end{tabular}
}
