...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & 1.29 & 0.07 & 0.00 & 1.66 & 0.28 & 0.16 &  \\ 
  Max & 6.25 & 2.70 & 2.69 & 3.22 & 1.23 & 1.74 &  \\ 
  Mean & 2.66 & 0.74 & 0.81 & 2.39 & 0.83 & 1.06 &  \\ 
  Median & 2.05 & 0.59 & 0.56 & 2.30 & 0.97 & 1.27 &  \\ 
  Stdev & 1.78 & 0.68 & 0.69 & 0.78 & 0.49 & 0.81 &  \\ 
  IQR & 1.01 & 0.29 & 0.46 & 0.78 & 0.48 & 0.79 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Lower middle income & 1.89 & 0.76 & 0.79 & --- & --- & --- &  \\ 
  Upper middle income & 1.9 & 0.52 & 0.54 & --- & --- & --- &  \\ 
  NA & --- & --- & --- & --- & --- & --- &  \\ 
  High income & 6.16 & 0.47 & 0.46 & --- & --- & --- &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:43:54 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & 2.05 & 0.52 & 0.48 & --- & --- & --- &  \\ 
  Europe and Central Asia & 6.07 & 0.48 & 0.49 & --- & --- & --- &  \\ 
  Latin America and Caribbean & 1.90 & 0.45 & 0.54 & --- & --- & --- &  \\ 
  Middle East and North Africa & 1.59 & 0.89 & 0.56 & 2.3 & 1.23 & 1.74 &  \\ 
  South Asia & 1.87 & 0.68 & 1.01 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & 2.19 & 0.78 & 0.70 & --- & --- & --- &  \\ 
  \end{tabular}
