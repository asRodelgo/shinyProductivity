...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & -7.04 & 0.25 & 0.24 & -7.13 & 0.10 & 0.09 &  \\ 
  Max & 3.06 & 4.66 & 4.22 & 3.47 & 5.71 & 8.76 &  \\ 
  Mean & -1.56 & 0.97 & 1.20 & -1.43 & 1.15 & 1.50 &  \\ 
  Median & -1.19 & 0.88 & 1.12 & -0.75 & 0.96 & 1.26 &  \\ 
  Stdev & 2.61 & 0.61 & 0.67 & 3.17 & 1.01 & 1.58 &  \\ 
  IQR & 4.40 & 0.37 & 0.57 & 5.39 & 0.64 & 0.61 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Low income & -4.43 & 0.70 & 1.00 & --- & --- & --- &  \\ 
  Lower middle income & -1.44 & 1.00 & 1.29 & --- & --- & --- &  \\ 
  Upper middle income & 0.43 & 0.70 & 0.93 & --- & --- & --- &  \\ 
  High income & -0.85 & 0.78 & 0.94 & --- & --- & --- &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & -3.92 & 1.00 & 1.03 & --- & --- & --- &  \\ 
  Europe and Central Asia & -0.67 & 0.82 & 1.03 & --- & --- & --- &  \\ 
  Latin America and Caribbean & -0.17 & 0.70 & 0.80 & --- & --- & --- &  \\ 
  Middle East and North Africa & 0.02 & 0.96 & 1.24 & --- & --- & --- &  \\ 
  South Asia & -2.34 & 1.05 & 1.20 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & -3.92 & 1.10 & 1.46 & --- & --- & --- &  \\ 
  \end{tabular}
