...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & -7.13 & 0.1 & 0.09 & -7.04 & 0.25 & 0.24 &  \\ 
  Max & 3.47 & 5.71 & 8.76 & 3.06 & 4.66 & 4.22 &  \\ 
  Mean & -1.43 & 1.15 & 1.5 & -1.56 & 0.97 & 1.2 &  \\ 
  Median & -0.75 & 0.96 & 1.26 & -1.19 & 0.88 & 1.12 &  \\ 
  Stdev & 3.17 & 1.01 & 1.58 & 2.61 & 0.61 & 0.67 &  \\ 
  IQR & 5.39 & 0.64 & 0.61 & 4.4 & 0.37 & 0.57 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Low income & --- & --- & --- & -4.43 & 0.7 & 1 &  \\ 
  Lower middle income & --- & --- & --- & -1.44 & 1 & 1.29 &  \\ 
  Upper middle income & --- & --- & --- & 0.43 & 0.7 & 0.93 &  \\ 
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:05:43 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & --- & --- & --- & -3.92 & 1 & 1.03 &  \\ 
  Europe and Central Asia & --- & --- & --- & -0.67 & 0.82 & 1.03 &  \\ 
  Latin America and Caribbean & --- & --- & --- & -0.17 & 0.7 & 0.8 &  \\ 
  Middle East and North Africa & --- & --- & --- & 0.02 & 0.96 & 1.24 &  \\ 
  South Asia & --- & --- & --- & -2.34 & 1.05 & 1.2 &  \\ 
  Sub-Saharan Africa & --- & --- & --- & -3.92 & 1.1 & 1.46 &  \\ 
  \end{tabular}
