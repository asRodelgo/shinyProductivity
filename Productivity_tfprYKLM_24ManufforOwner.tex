...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 1.87 & 0.07 & 0.1 & 1.5 & 0.35 & 0.35 &  \\ 
  Max & 5.07 & 2.61 & 2.28 & 2.91 & 1.45 & 1.56 &  \\ 
  Mean & 2.81 & 0.74 & 0.95 & 2.4 & 0.66 & 0.83 &  \\ 
  Median & 2.77 & 0.41 & 0.56 & 2.42 & 0.57 & 0.7 &  \\ 
  Stdev & 0.89 & 0.76 & 0.8 & 0.37 & 0.3 & 0.4 &  \\ 
  IQR & 0.54 & 0.7 & 1.22 & 0.24 & 0.18 & 0.53 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:05:12 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & 2.94 & 0.58 & 1.04 & 2.66 & 0.62 & 0.7 &  \\ 
  Europe and Central Asia & --- & --- & --- & 2.04 & 0.62 & 0.84 &  \\ 
  Latin America and Caribbean & --- & --- & --- & 2.22 & 0.48 & 0.5 &  \\ 
  Middle East and North Africa & --- & --- & --- & 2.52 & 0.61 & 0.86 &  \\ 
  South Asia & --- & --- & --- & 2.36 & 0.44 & 0.51 &  \\ 
  Sub-Saharan Africa & 2.88 & 1.17 & 1.94 & 2.63 & 1.39 & 1.45 &  \\ 
  \end{tabular}
