...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 1.7 & 0.03 & 0 & 1.3 & 0.15 & 0 &  \\ 
  Max & 6.13 & 2.04 & 4.65 & 6.66 & 1.64 & 1.86 &  \\ 
  Mean & 4.39 & 0.72 & 1.32 & 4.31 & 0.81 & 1.03 &  \\ 
  Median & 4.73 & 0.55 & 1.08 & 4.51 & 0.78 & 1 &  \\ 
  Stdev & 1.53 & 0.64 & 1.49 & 1.41 & 0.29 & 0.44 &  \\ 
  IQR & 0.77 & 0.67 & 1.09 & 1.08 & 0.17 & 0.57 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:04:18 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Low income & --- & --- & --- & 6.11 & 0.82 & 0.8 &  \\ 
  Lower middle income & --- & --- & --- & 4.98 & 0.85 & 1.4 &  \\ 
...
East Asia and Pacific & --- & --- & --- & 4.98 & 0.75 & 1.04 &  \\ 
  ...
  Latin America and Caribbean & --- & --- & --- & 4.41 & 0.7 & 0.8 &  \\ 
  Middle East and North Africa & --- & --- & --- & 4.51 & 0.74 & 0.85 &  \\ 
  South Asia & --- & --- & --- & 5.02 & 0.88 & 1.39 &  \\ 
  Sub-Saharan Africa & 4.29 & 1.21 & 2.69 & 3.91 & 1.64 & 1.86 &  \\ 
  \end{tabular}
