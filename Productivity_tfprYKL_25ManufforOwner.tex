...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & 1.30 & 0.15 & 0.00 & 1.70 & 0.03 & 0.00 &  \\ 
  Max & 6.66 & 1.64 & 1.86 & 6.13 & 2.04 & 4.65 &  \\ 
  Mean & 4.31 & 0.81 & 1.03 & 4.39 & 0.72 & 1.32 &  \\ 
  Median & 4.51 & 0.78 & 1.00 & 4.73 & 0.55 & 1.08 &  \\ 
  Stdev & 1.41 & 0.29 & 0.44 & 1.53 & 0.64 & 1.49 &  \\ 
  IQR & 1.08 & 0.17 & 0.57 & 0.77 & 0.67 & 1.09 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Low income & 6.11 & 0.82 & 0.80 & --- & --- & --- &  \\ 
  Lower middle income & 4.98 & 0.85 & 1.40 & --- & --- & --- &  \\ 
  Upper middle income & 4.51 & 0.68 & 0.75 & --- & --- & --- &  \\ 
  High income & 1.67 & 0.69 & 0.93 & --- & --- & --- &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & 4.98 & 0.75 & 1.04 & --- & --- & --- &  \\ 
  Europe and Central Asia & 2.86 & 0.85 & 1.18 & --- & --- & --- &  \\ 
  Latin America and Caribbean & 4.41 & 0.70 & 0.80 & --- & --- & --- &  \\ 
  Middle East and North Africa & 4.51 & 0.74 & 0.85 & --- & --- & --- &  \\ 
  South Asia & 5.02 & 0.88 & 1.39 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & 3.91 & 1.64 & 1.86 & 4.29 & 1.21 & 2.69 &  \\ 
  \end{tabular}
