...
\begin{minipage}[t]{0.99\textwidth} % top section
  \vspace{-0.5cm}
      ...
      \subsection*{\color{white!40!black}Indicator: \color{blue!40!black}Total factor productivity YKLM}
...
Min & 1.21 & 0.12 & 0.05 &  \\ 
  Max & 3.63 & 3.13 & 3.13 &  \\ 
  Mean & 2.43 & 0.86 & 1.08 &  \\ 
  Median & 2.38 & 0.79 & 1.00 &  \\ 
  Stdev & 0.47 & 0.50 & 0.66 &  \\ 
  IQR & 0.67 & 0.53 & 0.86 &  \\ 
  \end{tabular}
...
\begin{tabular}{lrrrl}
  & median & sd & iqr &  \\ 
  \hline
Low income & 2.31 & 1.31 & 1.58 &  \\ 
  Lower middle income & 2.76 & 0.84 & 1.01 &  \\ 
  Upper middle income & 2.40 & 0.77 & 0.98 &  \\ 
  High income & 2.17 & 0.57 & 0.84 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:30:20 2016
\begin{tabular}{lrrrl}
  & median & sd & iqr &  \\ 
  \hline
East Asia and Pacific & 2.66 & 1.18 & 1.25 &  \\ 
  Europe and Central Asia & 2.36 & 0.61 & 0.61 &  \\ 
  Latin America and Caribbean & 2.33 & 0.67 & 0.85 &  \\ 
  Middle East and North Africa & 2.70 & 0.74 & 0.98 &  \\ 
  South Asia & 2.25 & 1.17 & 1.46 &  \\ 
  Sub-Saharan Africa & 2.44 & 1.16 & 1.44 &  \\ 
  \end{tabular}
