...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & -6.16 & 0.08 & 0.11 & -6.27 & 0.42 & 0 &  \\ 
  Max & 1.66 & 1.25 & 2.51 & 3.02 & 1.71 & 1.86 &  \\ 
  Mean & -1.44 & 0.65 & 0.94 & -0.76 & 0.89 & 1.05 &  \\ 
  Median & 0.22 & 0.64 & 0.81 & 0.06 & 0.82 & 1.06 &  \\ 
  Stdev & 3.25 & 0.34 & 0.73 & 2.84 & 0.33 & 0.5 &  \\ 
  IQR & 5.42 & 0.25 & 0.68 & 3.07 & 0.33 & 0.53 &  \\ 
  \end{tabular}
...
East Asia and Pacific & --- & --- & --- & -2.93 & 0.96 & 1.08 &  \\ 
  ...
  Sub-Saharan Africa & -0.41 & 1.25 & 2.51 & -0.8 & 1.71 & 1.75 &  \\ 
  \end{tabular}
