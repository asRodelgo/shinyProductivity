...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   ...
   \hline
Min & 1.32 & 0.1 & 0.15 & 1.1 & 0.07 & 0.06 &  \\ 
  Max & 2.7 & 1.75 & 2.89 & 3.16 & 4.47 & 5.56 &  \\ 
  Mean & 1.94 & 0.75 & 1.06 & 2.05 & 0.86 & 1.07 &  \\ 
  Median & 1.91 & 0.73 & 1 & 1.89 & 0.7 & 0.75 &  \\ 
  Stdev & 0.39 & 0.31 & 0.57 & 0.52 & 0.87 & 1.11 &  \\ 
  IQR & 0.46 & 0.17 & 0.39 & 0.56 & 0.27 & 0.68 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:00:54 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Low income & 2.14 & 0.55 & 0.92 & 1.56 & 0.23 & 0.23 &  \\ 
  Lower middle income & 1.96 & 0.83 & 1.1 & 1.86 & 0.67 & 0.93 &  \\ 
  Upper middle income & --- & --- & --- & 1.86 & 0.7 & 0.68 &  \\ 
  High income & 2.29 & 0.74 & 1.03 & 2.77 & 0.76 & 1.15 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & 2.04 & 0.71 & 0.8 & 2.13 & 0.64 & 0.75 &  \\ 
  Europe and Central Asia & 1.32 & 0.69 & 1 & 1.74 & 0.96 & 1.37 &  \\ 
  Latin America and Caribbean & --- & --- & --- & 1.89 & 0.67 & 0.75 &  \\ 
  Middle East and North Africa & 1.76 & 0.39 & 0.43 & 2.04 & 0.81 & 1.08 &  \\ 
  South Asia & 2.5 & 0.81 & 1.12 & 1.67 & 0.73 & 0.9 &  \\ 
  Sub-Saharan Africa & 1.82 & 0.68 & 0.78 & 1.89 & 0.71 & 0.59 &  \\ 
  \end{tabular}
