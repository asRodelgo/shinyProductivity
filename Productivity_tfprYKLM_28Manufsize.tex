...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  ...
  \hline
Min & -0.06 & 0.12 & 0.13 & 1.39 & 0.05 & 0.04 & 1.26 & 0.12 & 0.10 &  \\ 
  Max & 2.64 & 1.82 & 3.92 & 3.28 & 1.29 & 2.16 & 3.80 & 1.78 & 2.61 &  \\ 
  Mean & 1.67 & 0.63 & 0.90 & 1.93 & 0.51 & 0.68 & 1.91 & 0.62 & 0.77 &  \\ 
  Median & 1.67 & 0.49 & 0.59 & 1.85 & 0.42 & 0.54 & 1.75 & 0.50 & 0.58 &  \\ 
  Stdev & 0.61 & 0.39 & 0.87 & 0.48 & 0.39 & 0.65 & 0.58 & 0.42 & 0.64 &  \\ 
  IQR & 0.45 & 0.40 & 1.05 & 0.30 & 0.45 & 0.67 & 0.31 & 0.30 & 0.42 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  ...
  \hline
Low income & 0.15 & 0.54 & 0.51 & --- & --- & --- & --- & --- & --- &  \\ 
  Lower middle income & 1.74 & 0.52 & 0.62 & --- & --- & --- & 1.86 & 0.58 & 0.53 &  \\ 
  Upper middle income & 1.67 & 0.49 & 0.59 & --- & --- & --- & 1.75 & 0.53 & 0.66 &  \\ 
  High income & 1.42 & 0.30 & 0.31 & --- & --- & --- & 1.55 & 0.32 & 0.48 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  & median\_Small.firms & sd\_Small.firms & iqr\_Small.firms & median\_Large.firms & sd\_Large.firms & iqr\_Large.firms & median\_Medium.firms & sd\_Medium.firms & iqr\_Medium.firms &  \\ 
  \hline
East Asia and Pacific & 1.83 & 0.41 & 0.34 & 1.91 & 0.48 & 0.47 & 1.92 & 0.58 & 0.72 &  \\ 
  Europe and Central Asia & 1.91 & 0.38 & 0.29 & --- & --- & --- & 1.65 & 0.49 & 0.6 &  \\ 
  Latin America and Caribbean & 1.62 & 0.49 & 0.59 & 1.76 & 0.43 & 0.51 & 1.66 & 0.4 & 0.44 &  \\ 
  Middle East and North Africa & 1.60 & 0.52 & 0.62 & --- & --- & --- & 1.65 & 0.66 & 0.53 &  \\ 
  South Asia & 1.73 & 0.39 & 0.49 & --- & --- & --- & --- & --- & --- &  \\ 
  Sub-Saharan Africa & 2.04 & 0.86 & 1.53 & --- & --- & --- & 2.43 & 1.07 & 1.28 &  \\ 
  \end{tabular}
}
