...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  &   & Small firms &   &   & Medium firms &   &   & Large firms &   &   \\ 
   ...
   \hline
Min & -0.06 & 0.12 & 0.13 & 1.26 & 0.12 & 0.1 & 1.39 & 0.05 & 0.04 &  \\ 
  Max & 2.64 & 1.82 & 3.92 & 3.8 & 1.78 & 2.61 & 3.28 & 1.29 & 2.16 &  \\ 
  Mean & 1.67 & 0.63 & 0.9 & 1.91 & 0.62 & 0.77 & 1.93 & 0.51 & 0.68 &  \\ 
  Median & 1.67 & 0.49 & 0.59 & 1.75 & 0.5 & 0.58 & 1.85 & 0.42 & 0.54 &  \\ 
  Stdev & 0.61 & 0.39 & 0.87 & 0.58 & 0.42 & 0.64 & 0.48 & 0.39 & 0.65 &  \\ 
  IQR & 0.45 & 0.4 & 1.05 & 0.31 & 0.3 & 0.42 & 0.3 & 0.45 & 0.67 &  \\ 
  \end{tabular}
}
...
Low income & 0.15 & 0.54 & 0.51 & --- & --- & --- & --- & --- & --- &  \\ 
  ...
  High income & 1.42 & 0.3 & 0.31 & 1.55 & 0.32 & 0.48 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  &   & Small firms &   &   & Medium firms &   &   & Large firms &   &   \\ 
   & median & sd & IQR & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & 1.83 & 0.41 & 0.34 & 1.92 & 0.58 & 0.72 & 1.91 & 0.48 & 0.47 &  \\ 
  Europe and Central Asia & 1.91 & 0.38 & 0.29 & 1.65 & 0.49 & 0.6 & --- & --- & --- &  \\ 
  Latin America and Caribbean & 1.62 & 0.49 & 0.59 & 1.66 & 0.4 & 0.44 & 1.76 & 0.43 & 0.51 &  \\ 
  Middle East and North Africa & 1.6 & 0.52 & 0.62 & 1.65 & 0.66 & 0.53 & --- & --- & --- &  \\ 
