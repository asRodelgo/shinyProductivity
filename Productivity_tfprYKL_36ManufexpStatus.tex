...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   ...
   \hline
Min & -0.14 & 0.31 & 0 & -0.19 & 0.22 & 0 &  \\ 
  Max & 3 & 3.03 & 4.82 & 5.6 & 4.56 & 8.61 &  \\ 
  Mean & 1.95 & 0.82 & 1.1 & 2.35 & 1 & 1.53 &  \\ 
  Median & 2.24 & 0.69 & 0.87 & 2.71 & 0.67 & 1.04 &  \\ 
  Stdev & 1.02 & 0.66 & 1.13 & 1.81 & 1.1 & 2.19 &  \\ 
  IQR & 0.92 & 0.31 & 0.67 & 2.69 & 0.38 & 0.67 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:01:41 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Low income & 0.54 & 0.61 & 0.64 & -0.02 & 0.53 & 1.04 &  \\ 
  Lower middle income & 2.53 & 0.74 & 1.06 & --- & --- & --- &  \\ 
  Upper middle income & 2.26 & 0.62 & 0.65 & --- & --- & --- &  \\ 
  High income & -0.14 & 0.38 & 0.4 & 0.02 & 0.62 & 0.55 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & 2.16 & 0.52 & 0.69 & 2.78 & 0.75 & 0.92 &  \\ 
  Europe and Central Asia & -0.14 & 0.38 & 0.4 & 0.02 & 0.62 & 0.55 &  \\ 
  Latin America and Caribbean & 2.23 & 0.47 & 0.32 & 2.84 & 0.45 & 0.44 &  \\ 
  Middle East and North Africa & 2.6 & 0.81 & 1.06 & --- & --- & --- &  \\ 
  South Asia & 2.53 & 0.58 & 0.64 & 3.78 & 0.91 & 1.29 &  \\ 
  Sub-Saharan Africa & 2.53 & 0.97 & 1.68 & --- & --- & --- &  \\ 
  \end{tabular}
