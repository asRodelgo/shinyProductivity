...
\begin{minipage}[t]{0.99\textwidth} % top section
  \vspace{-0.5cm}
      ...
      \subsection*{\color{white!40!black}Indicator: \color{blue!40!black}Total factor productivity NSKL: Fabricated metal products}
...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  ...
  \hline
Min & -8.16 & 0.16 & 0.28 & -8.46 & 0.19 & 0.00 & -8.21 & 0.31 & 0.30 &  \\ 
  Max & 7.11 & 2.30 & 4.42 & 6.35 & 1.75 & 3.36 & 6.17 & 1.20 & 1.91 &  \\ 
  Mean & -0.62 & 0.92 & 1.20 & -1.21 & 0.76 & 0.97 & -0.45 & 0.79 & 1.08 &  \\ 
  Median & -0.32 & 0.80 & 0.91 & -0.52 & 0.74 & 0.67 & 0.23 & 0.77 & 1.03 &  \\ 
  Stdev & 3.98 & 0.54 & 0.88 & 4.07 & 0.39 & 0.71 & 4.21 & 0.30 & 0.54 &  \\ 
  IQR & 5.01 & 0.60 & 0.51 & 4.97 & 0.41 & 0.85 & 4.64 & 0.39 & 0.90 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  ...
  \hline
Low income & --- & --- & --- & -5.27 & 0.54 & 0.63 & --- & --- & --- &  \\ 
  Lower middle income & -2.79 & 0.78 & 0.99 & -2.83 & 0.88 & 1.23 & --- & --- & --- &  \\ 
  Upper middle income & -0.41 & 0.95 & 0.95 & -0.73 & 0.80 & 0.85 & --- & --- & --- &  \\ 
  High income & 5.34 & 0.53 & 0.85 & 4.32 & 0.40 & 0.42 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  & median\_Medium.firms & sd\_Medium.firms & iqr\_Medium.firms & median\_Small.firms & sd\_Small.firms & iqr\_Small.firms & median\_Large.firms & sd\_Large.firms & iqr\_Large.firms &  \\ 
  \hline
East Asia and Pacific & -4.29 & 1.22 & 1.61 & -4.59 & 0.64 & 0.57 & -4.17 & 0.78 & 1.04 &  \\ 
  Europe and Central Asia & 4.79 & 0.93 & 0.79 & 4.54 & 0.62 & 0.95 & --- & --- & --- &  \\ 
  Latin America and Caribbean & -0.22 & 0.74 & 0.87 & 0.07 & 0.72 & 0.67 & --- & --- & --- &  \\ 
  Middle East and North Africa & -0.42 & 0.78 & 0.78 & -0.52 & 0.74 & 0.58 & --- & --- & --- &  \\ 
  South Asia & --- & --- & --- & -4.06 & 0.54 & 0.87 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & -1.85 & 0.9 & 1.57 & -1.82 & 1.06 & 1.54 & --- & --- & --- &  \\ 
  \end{tabular}
}
