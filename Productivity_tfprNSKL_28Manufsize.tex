...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  &   & Small firms &   &   & Medium firms &   &   & Large firms &   &   \\ 
   ...
   \hline
Min & -8.46 & 0.19 & 0 & -8.16 & 0.16 & 0.28 & -8.21 & 0.31 & 0.3 &  \\ 
  Max & 6.35 & 1.75 & 3.36 & 7.11 & 2.3 & 4.42 & 6.17 & 1.2 & 1.91 &  \\ 
  Mean & -1.21 & 0.76 & 0.97 & -0.62 & 0.92 & 1.2 & -0.45 & 0.79 & 1.08 &  \\ 
  Median & -0.52 & 0.74 & 0.67 & -0.32 & 0.8 & 0.91 & 0.23 & 0.77 & 1.03 &  \\ 
  Stdev & 4.07 & 0.39 & 0.71 & 3.98 & 0.54 & 0.88 & 4.21 & 0.3 & 0.54 &  \\ 
  IQR & 4.97 & 0.41 & 0.85 & 5.01 & 0.6 & 0.51 & 4.64 & 0.39 & 0.9 &  \\ 
  \end{tabular}
}
...
Low income & -5.27 & 0.54 & 0.63 & --- & --- & --- & --- & --- & --- &  \\ 
  Lower middle income & -2.83 & 0.88 & 1.23 & -2.79 & 0.78 & 0.99 & --- & --- & --- &  \\ 
  Upper middle income & -0.73 & 0.8 & 0.85 & -0.41 & 0.95 & 0.95 & --- & --- & --- &  \\ 
  High income & 4.32 & 0.4 & 0.42 & 5.34 & 0.53 & 0.85 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  &   & Small firms &   &   & Medium firms &   &   & Large firms &   &   \\ 
   & median & sd & IQR & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & -4.59 & 0.64 & 0.57 & -4.29 & 1.22 & 1.61 & -4.17 & 0.78 & 1.04 &  \\ 
  Europe and Central Asia & 4.54 & 0.62 & 0.95 & 4.79 & 0.93 & 0.79 & --- & --- & --- &  \\ 
  Latin America and Caribbean & 0.07 & 0.72 & 0.67 & -0.22 & 0.74 & 0.87 & --- & --- & --- &  \\ 
  Middle East and North Africa & -0.52 & 0.74 & 0.58 & -0.42 & 0.78 & 0.78 & --- & --- & --- &  \\ 
  South Asia & -4.06 & 0.54 & 0.87 & --- & --- & --- & --- & --- & --- &  \\ 
  Sub-Saharan Africa & -1.82 & 1.06 & 1.54 & -1.85 & 0.9 & 1.57 & --- & --- & --- &  \\ 
  \end{tabular}
}
