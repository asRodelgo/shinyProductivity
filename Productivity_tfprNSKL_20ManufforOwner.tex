...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & -7.77 & 0.46 & 0.55 & 2.06 & 0.66 & 0.93 &  \\ 
  Max & 3.42 & 1.05 & 1.64 & 2.06 & 0.66 & 0.93 &  \\ 
  Mean & -1.67 & 0.79 & 1.16 & 2.06 & 0.66 & 0.93 &  \\ 
  Median & -1.25 & 0.78 & 1.12 & 2.06 & 0.66 & 0.93 &  \\ 
  Stdev & 3.04 & 0.17 & 0.34 & --- & --- & --- &  \\ 
  IQR & 2.97 & 0.17 & 0.48 & 0 & 0 & 0 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Low income & -7.77 & 0.94 & 1.53 & --- & --- & --- &  \\ 
  Lower middle income & -1.25 & 0.78 & 1.04 & --- & --- & --- &  \\ 
  Upper middle income & 3.42 & 1.01 & 1.50 & 2.06 & 0.66 & 0.93 &  \\ 
  High income & -0.71 & 0.69 & 1.32 & --- & --- & --- &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & -4.64 & 0.94 & 1.23 & --- & --- & --- &  \\ 
  Europe and Central Asia & 1.83 & 0.90 & 1.57 & --- & --- & --- &  \\ 
  Latin America and Caribbean & -1.64 & 0.59 & 0.99 & --- & --- & --- &  \\ 
  Middle East and North Africa & 0.70 & 0.79 & 0.81 & --- & --- & --- &  \\ 
  South Asia & -1.05 & 0.72 & 1.04 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & -7.77 & 0.94 & 1.53 & --- & --- & --- &  \\ 
  \end{tabular}
