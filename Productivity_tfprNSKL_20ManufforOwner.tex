...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 2.06 & 0.66 & 0.93 & -7.77 & 0.46 & 0.55 &  \\ 
  Max & 2.06 & 0.66 & 0.93 & 3.42 & 1.05 & 1.64 &  \\ 
  Mean & 2.06 & 0.66 & 0.93 & -1.67 & 0.79 & 1.16 &  \\ 
  Median & 2.06 & 0.66 & 0.93 & -1.25 & 0.78 & 1.12 &  \\ 
  Stdev & --- & --- & --- & 3.04 & 0.17 & 0.34 &  \\ 
  IQR & 0 & 0 & 0 & 2.97 & 0.17 & 0.48 &  \\ 
  \end{tabular}
...
Low income & --- & --- & --- & -7.77 & 0.94 & 1.53 &  \\ 
  ...
  Upper middle income & 2.06 & 0.66 & 0.93 & 3.42 & 1.01 & 1.5 &  \\ 
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:05:57 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & --- & --- & --- & -4.64 & 0.94 & 1.23 &  \\ 
  Europe and Central Asia & --- & --- & --- & 1.83 & 0.9 & 1.57 &  \\ 
  Latin America and Caribbean & --- & --- & --- & -1.64 & 0.59 & 0.99 &  \\ 
  Middle East and North Africa & --- & --- & --- & 0.7 & 0.79 & 0.81 &  \\ 
