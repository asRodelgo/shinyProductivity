...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & 2.99 & 0.19 & 0.00 & 3.23 & 0.17 & 0.24 &  \\ 
  Max & 4.73 & 2.11 & 2.15 & 4.86 & 1.73 & 1.96 &  \\ 
  Mean & 3.58 & 0.93 & 1.17 & 3.94 & 0.74 & 0.95 &  \\ 
  Median & 3.44 & 0.83 & 1.12 & 3.80 & 0.60 & 0.79 &  \\ 
  Stdev & 0.51 & 0.41 & 0.51 & 0.58 & 0.44 & 0.53 &  \\ 
  IQR & 0.52 & 0.25 & 0.40 & 0.95 & 0.52 & 0.63 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:43:57 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & 3.82 & 0.82 & 1.15 & 3.76 & 0.75 & 0.92 &  \\ 
  Europe and Central Asia & 3.34 & 0.84 & 1.00 & --- & --- & --- &  \\ 
  Latin America and Caribbean & 3.54 & 0.73 & 0.98 & --- & --- & --- &  \\ 
  Middle East and North Africa & 3.22 & 0.97 & 1.20 & --- & --- & --- &  \\ 
  South Asia & 3.44 & 0.96 & 1.34 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & 3.45 & 1.42 & 1.84 & 3.7 & 0.96 & 1.56 &  \\ 
  \end{tabular}
