...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 3.23 & 0.17 & 0.24 & 2.99 & 0.19 & 0 &  \\ 
  Max & 4.86 & 1.73 & 1.96 & 4.73 & 2.11 & 2.15 &  \\ 
  Mean & 3.94 & 0.74 & 0.95 & 3.58 & 0.93 & 1.17 &  \\ 
  Median & 3.8 & 0.6 & 0.79 & 3.44 & 0.83 & 1.12 &  \\ 
  Stdev & 0.58 & 0.44 & 0.53 & 0.51 & 0.41 & 0.51 &  \\ 
  IQR & 0.95 & 0.52 & 0.63 & 0.52 & 0.25 & 0.4 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:04:14 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Lower middle income & --- & --- & --- & 3.44 & 1.06 & 1.27 &  \\ 
  Upper middle income & --- & --- & --- & 3.22 & 0.83 & 1.12 &  \\ 
  NA & --- & --- & --- & --- & --- & --- &  \\ 
  High income & --- & --- & --- & 4.14 & 0.66 & 0.8 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:04:15 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & 3.76 & 0.75 & 0.92 & 3.82 & 0.82 & 1.15 &  \\ 
  Europe and Central Asia & --- & --- & --- & 3.34 & 0.84 & 1 &  \\ 
  Latin America and Caribbean & --- & --- & --- & 3.54 & 0.73 & 0.98 &  \\ 
  Middle East and North Africa & --- & --- & --- & 3.22 & 0.97 & 1.2 &  \\ 
  South Asia & --- & --- & --- & 3.44 & 0.96 & 1.34 &  \\ 
  Sub-Saharan Africa & 3.7 & 0.96 & 1.56 & 3.45 & 1.42 & 1.84 &  \\ 
  \end{tabular}
