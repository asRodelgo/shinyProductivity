...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & -4.67 & 0.14 & 0.14 & -5.21 & 0.04 & 0 &  \\ 
  Max & 3.24 & 1.14 & 1.9 & 2.49 & 1.86 & 2.26 &  \\ 
  Mean & -0.27 & 0.66 & 0.92 & -0.98 & 0.86 & 1.15 &  \\ 
  Median & 0.43 & 0.74 & 0.84 & -0.75 & 0.87 & 1.02 &  \\ 
  Stdev & 3.25 & 0.45 & 0.7 & 2.42 & 0.36 & 0.58 &  \\ 
  IQR & 5.57 & 0.84 & 1.19 & 3.77 & 0.17 & 0.48 &  \\ 
  \end{tabular}
...
Low income & --- & --- & --- & -0.75 & 0.87 & 1.32 &  \\ 
  ...
  Upper middle income & --- & --- & --- & 1.03 & 0.88 & 1.1 &  \\ 
  High income & --- & --- & --- & -1.1 & 0.73 & 0.96 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:06:10 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & --- & --- & --- & -2.97 & 0.73 & 1.02 &  \\ 
  Europe and Central Asia & --- & --- & --- & -1.1 & 0.73 & 1 &  \\ 
  Latin America and Caribbean & --- & --- & --- & 0.17 & 0.88 & 0.96 &  \\ 
  Middle East and North Africa & --- & --- & --- & -0.51 & 0.8 & 1 &  \\ 
  South Asia & --- & --- & --- & -0.75 & 0.87 & 1.16 &  \\ 
  Sub-Saharan Africa & 3.24 & 1.14 & 1.79 & 1.68 & 1.86 & 2.18 &  \\ 
  \end{tabular}
