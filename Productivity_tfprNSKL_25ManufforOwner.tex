...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & -5.21 & 0.04 & 0.00 & -4.67 & 0.14 & 0.14 &  \\ 
  Max & 2.49 & 1.86 & 2.26 & 3.24 & 1.14 & 1.90 &  \\ 
  Mean & -0.98 & 0.86 & 1.15 & -0.27 & 0.66 & 0.92 &  \\ 
  Median & -0.75 & 0.87 & 1.02 & 0.43 & 0.74 & 0.84 &  \\ 
  Stdev & 2.42 & 0.36 & 0.58 & 3.25 & 0.45 & 0.70 &  \\ 
  IQR & 3.77 & 0.17 & 0.48 & 5.57 & 0.84 & 1.19 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Low income & -0.75 & 0.87 & 1.32 & --- & --- & --- &  \\ 
  Lower middle income & -0.57 & 0.83 & 1.09 & --- & --- & --- &  \\ 
  Upper middle income & 1.03 & 0.88 & 1.10 & --- & --- & --- &  \\ 
  High income & -1.10 & 0.73 & 0.96 & --- & --- & --- &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:45:47 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & -2.97 & 0.73 & 1.02 & --- & --- & --- &  \\ 
  Europe and Central Asia & -1.10 & 0.73 & 1.00 & --- & --- & --- &  \\ 
  Latin America and Caribbean & 0.17 & 0.88 & 0.96 & --- & --- & --- &  \\ 
  Middle East and North Africa & -0.51 & 0.80 & 1.00 & --- & --- & --- &  \\ 
  South Asia & -0.75 & 0.87 & 1.16 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & 1.68 & 1.86 & 2.18 & 3.24 & 1.14 & 1.79 &  \\ 
  \end{tabular}
