...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 1.04 & 0.35 & 0.47 & 0.56 & 0.25 & 0.26 &  \\ 
  Max & 2.83 & 1.34 & 2.57 & 6.79 & 2.06 & 2.9 &  \\ 
  Mean & 1.89 & 0.85 & 1.31 & 2.4 & 0.94 & 1.19 &  \\ 
  Median & 1.93 & 0.91 & 1.29 & 2.06 & 0.91 & 1.12 &  \\ 
  Stdev & 0.63 & 0.32 & 0.66 & 1.3 & 0.39 & 0.56 &  \\ 
  IQR & 0.92 & 0.25 & 0.73 & 0.93 & 0.26 & 0.55 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:04:22 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & --- & --- & --- & 2.1 & 0.85 & 0.98 &  \\ 
  Europe and Central Asia & --- & --- & --- & 2.49 & 0.93 & 1.31 &  \\ 
  Latin America and Caribbean & --- & --- & --- & 1.8 & 0.8 & 1.38 &  \\ 
  Middle East and North Africa & --- & --- & --- & 2.08 & 0.97 & 1.21 &  \\ 
  South Asia & --- & --- & --- & 2.1 & 0.84 & 1 &  \\ 
  Sub-Saharan Africa & 1.96 & 1.07 & 2.16 & 2.15 & 0.81 & 0.88 &  \\ 
  \end{tabular}
