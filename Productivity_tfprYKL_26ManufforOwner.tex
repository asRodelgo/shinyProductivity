...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & 0.56 & 0.25 & 0.26 & 1.04 & 0.35 & 0.47 &  \\ 
  Max & 6.79 & 2.06 & 2.90 & 2.83 & 1.34 & 2.57 &  \\ 
  Mean & 2.40 & 0.94 & 1.19 & 1.89 & 0.85 & 1.31 &  \\ 
  Median & 2.06 & 0.91 & 1.12 & 1.93 & 0.91 & 1.29 &  \\ 
  Stdev & 1.30 & 0.39 & 0.56 & 0.63 & 0.32 & 0.66 &  \\ 
  IQR & 0.93 & 0.26 & 0.55 & 0.92 & 0.25 & 0.73 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Lower middle income & 2.12 & 0.95 & 1.09 & --- & --- & --- &  \\ 
  Upper middle income & 2.01 & 0.74 & 0.88 & --- & --- & --- &  \\ 
  NA & --- & --- & --- & --- & --- & --- &  \\ 
  High income & 5.8 & 1.51 & 1.53 & --- & --- & --- &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:44:04 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & 2.10 & 0.85 & 0.98 & --- & --- & --- &  \\ 
  Europe and Central Asia & 2.49 & 0.93 & 1.31 & --- & --- & --- &  \\ 
  Latin America and Caribbean & 1.80 & 0.80 & 1.38 & --- & --- & --- &  \\ 
  Middle East and North Africa & 2.08 & 0.97 & 1.21 & --- & --- & --- &  \\ 
  South Asia & 2.10 & 0.84 & 1.00 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & 2.15 & 0.81 & 0.88 & 1.96 & 1.07 & 2.16 &  \\ 
  \end{tabular}
