...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 1.89 & 0.63 & 0.91 & 1.53 & 0.51 & 0.67 &  \\ 
  Max & 1.89 & 0.63 & 0.91 & 2.69 & 1.15 & 1.25 &  \\ 
  Mean & 1.89 & 0.63 & 0.91 & 2.25 & 0.88 & 1.04 &  \\ 
  Median & 1.89 & 0.63 & 0.91 & 2.27 & 0.88 & 1.12 &  \\ 
  Stdev & --- & --- & --- & 0.45 & 0.24 & 0.22 &  \\ 
  IQR & 0 & 0 & 0 & 0.33 & 0.13 & 0.11 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:04:25 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Upper middle income & 1.89 & 0.63 & 0.91 & 2.21 & 0.51 & 0.67 &  \\ 
  NA & --- & --- & --- & --- & --- & --- &  \\ 
  NA.1 & --- & --- & --- & --- & --- & --- &  \\ 
  Lower middle income & --- & --- & --- & 2.4 & 0.94 & 1.13 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:04:26 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & --- & --- & --- & 2.24 & 0.76 & 0.89 &  \\ 
  Middle East and North Africa & --- & --- & --- & 1.53 & 0.88 & 1.14 &  \\ 
  South Asia & --- & --- & --- & 2.61 & 1.01 & 1.14 &  \\ 
  \end{tabular}
