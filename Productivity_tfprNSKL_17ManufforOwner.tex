...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & -8.60 & 0.58 & 0.58 & -9.27 & 0.25 & 0.22 &  \\ 
  Max & 0.94 & 2.73 & 3.86 & 0.38 & 1.81 & 3.95 &  \\ 
  Mean & -2.95 & 1.34 & 1.80 & -3.09 & 0.80 & 1.08 &  \\ 
  Median & -1.79 & 0.97 & 1.74 & -2.31 & 0.78 & 1.01 &  \\ 
  Stdev & 3.50 & 0.73 & 1.09 & 2.87 & 0.31 & 0.73 &  \\ 
  IQR & 4.01 & 0.73 & 0.97 & 3.14 & 0.28 & 0.32 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Low income & --- & --- & --- & -4.57 & 0.71 & 0.98 &  \\ 
  Lower middle income & --- & --- & --- & -3.14 & 0.78 & 1.04 &  \\ 
  Upper middle income & --- & --- & --- & -0.92 & 0.69 & 0.84 &  \\ 
  High income & --- & --- & --- & -1.46 & 0.93 & 1.14 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership &  \\ 
  \hline
East Asia and Pacific & --- & --- & --- & -8.88 & 0.60 & 0.73 &  \\ 
  Latin America and Caribbean & --- & --- & --- & -1.62 & 0.84 & 1.04 &  \\ 
  Middle East and North Africa & --- & --- & --- & -0.62 & 0.73 & 0.87 &  \\ 
  South Asia & --- & --- & --- & -3.14 & 0.85 & 1.21 &  \\ 
  Sub-Saharan Africa & -2.93 & 1.71 & 2.42 & -3.04 & 0.73 & 0.90 &  \\ 
  \end{tabular}
