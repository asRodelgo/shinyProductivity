...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  & mean\_Medium.firms & median\_Medium.firms & sd\_Medium.firms & mean\_Large.firms & median\_Large.firms & sd\_Large.firms & mean\_Small.firms & median\_Small.firms & sd\_Small.firms &  \\ 
  \hline
Min & 1.14 & 0.43 & 0.00 & 1.34 & 0.40 & 0.29 & 1.48 & 0.26 & 0.43 &  \\ 
  Max & 7.55 & 2.33 & 3.90 & 8.12 & 1.31 & 1.58 & 6.09 & 1.08 & 2.02 &  \\ 
  Mean & 4.50 & 0.86 & 1.19 & 4.85 & 0.74 & 0.96 & 4.28 & 0.72 & 0.92 &  \\ 
  Median & 4.84 & 0.73 & 0.89 & 5.04 & 0.65 & 1.01 & 4.44 & 0.72 & 0.83 &  \\ 
  Stdev & 1.64 & 0.47 & 0.98 & 1.89 & 0.32 & 0.38 & 1.14 & 0.21 & 0.41 &  \\ 
  IQR & 1.42 & 0.39 & 0.47 & 1.19 & 0.38 & 0.58 & 1.05 & 0.29 & 0.37 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  ...
  \hline
Low income & 7.55 & 0.50 & 0.00 & 8.12 & 0.4 & 0.57 & 6.09 & 0.26 & 0.43 &  \\ 
  Lower middle income & 5.23 & 0.80 & 1.09 & --- & --- & --- & 4.58 & 0.81 & 1.12 &  \\ 
  Upper middle income & 4.84 & 0.75 & 0.85 & --- & --- & --- & 4.49 & 0.74 & 0.68 &  \\ 
  High income & 1.42 & 0.54 & 0.88 & 1.8 & 0.71 & 1 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:37:38 2016
{\footnotesize
\begin{tabular}{>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
  & median\_Medium.firms & sd\_Medium.firms & iqr\_Medium.firms & median\_Large.firms & sd\_Large.firms & iqr\_Large.firms & median\_Small.firms & sd\_Small.firms & iqr\_Small.firms &  \\ 
  \hline
East Asia and Pacific & 5.01 & 0.73 & 0.74 & --- & --- & --- & 4.89 & 0.76 & 0.88 &  \\ 
  Europe and Central Asia & 2.86 & 1.43 & 2.39 & --- & --- & --- & 2.91 & 0.88 & 0.78 &  \\ 
  Latin America and Caribbean & 4.67 & 0.64 & 0.80 & 4.73 & 0.59 & 1 & --- & --- & --- &  \\ 
  Middle East and North Africa & 4.40 & 0.78 & 1.23 & --- & --- & --- & 4.82 & 0.86 & 1.09 &  \\ 
  South Asia & 5.45 & 0.86 & 1.15 & --- & --- & --- & 4.44 & 0.71 & 0.96 &  \\ 
  Sub-Saharan Africa & 3.87 & 1.71 & 3.21 & 4.85 & 1.26 & 1.25 & 3.61 & 0.72 & 1.42 &  \\ 
  \end{tabular}
}
