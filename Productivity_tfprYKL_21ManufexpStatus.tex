...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   ...
   \hline
Min & 2.13 & 0.44 & 0.37 & 1.14 & 0.49 & 0.52 &  \\ 
  Max & 3.1 & 1.05 & 1.83 & 2.92 & 1.3 & 2.26 &  \\ 
  Mean & 2.64 & 0.67 & 1 & 2.14 & 0.86 & 1.37 &  \\ 
  Median & 2.66 & 0.6 & 0.91 & 2.25 & 0.83 & 1.35 &  \\ 
  Stdev & 0.46 & 0.27 & 0.64 & 0.74 & 0.4 & 0.89 &  \\ 
  IQR & 0.66 & 0.25 & 0.73 & 0.59 & 0.61 & 1.42 &  \\ 
  \end{tabular}
...
NA & --- & --- & --- & --- & --- & --- &  \\ 
  NA.1 & --- & --- & --- & --- & --- & --- &  \\ 
  NA.2 & --- & --- & --- & --- & --- & --- &  \\ 
  Lower middle income & 2.66 & 0.6 & 0.91 & 2.25 & 0.83 & 1.35 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:01:08 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & 3.1 & 0.44 & 0.37 & 2.15 & 1.1 & 2.01 &  \\ 
  Middle East and North Africa & 2.13 & 0.53 & 0.66 & 2.92 & 1.3 & 2.26 &  \\ 
  South Asia & 2.66 & 0.86 & 1.49 & 1.74 & 0.52 & 0.61 &  \\ 
  \end{tabular}
