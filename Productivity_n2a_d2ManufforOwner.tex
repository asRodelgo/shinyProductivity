...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 0.01 & 0.01 & 0 & 0.01 & 0.03 & 0.03 &  \\ 
  Max & 0.6 & 0.44 & 0.49 & 0.37 & 0.33 & 0.44 &  \\ 
  Mean & 0.17 & 0.13 & 0.17 & 0.19 & 0.16 & 0.22 &  \\ 
  Median & 0.16 & 0.11 & 0.15 & 0.19 & 0.16 & 0.2 &  \\ 
  Stdev & 0.11 & 0.07 & 0.11 & 0.06 & 0.05 & 0.08 &  \\ 
  IQR & 0.13 & 0.1 & 0.13 & 0.09 & 0.07 & 0.11 &  \\ 
  \end{tabular}
...
Low income & --- & --- & --- & 0.14 & 0.15 & 0.19 &  \\ 
  ...
  Upper middle income & --- & --- & --- & 0.2 & 0.17 & 0.19 &  \\ 
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:03:33 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & 0.21 & 0.11 & 0.13 & 0.2 & 0.16 & 0.19 &  \\ 
  Europe and Central Asia & --- & --- & --- & 0.2 & 0.19 & 0.26 &  \\ 
  Latin America and Caribbean & --- & --- & --- & 0.2 & 0.14 & 0.16 &  \\ 
  Middle East and North Africa & --- & --- & --- & 0.16 & 0.16 & 0.2 &  \\ 
  South Asia & --- & --- & --- & 0.15 & 0.2 & 0.23 &  \\ 
  Sub-Saharan Africa & 0.08 & 0.13 & 0.17 & 0.14 & 0.15 & 0.19 &  \\ 
  \end{tabular}
