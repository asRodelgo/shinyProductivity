...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): expecting a string vector}}\end{kframe}
      \vspace*{0.5cm}
    \end{minipage}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'incomeLevel' not found}}\end{kframe}
      \vspace*{0.5cm}
    \end{minipage}
%\end{minipage}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'region' not found}}\end{kframe}
      \vspace*{0.5cm}
    \end{minipage}
%\end{minipage}
