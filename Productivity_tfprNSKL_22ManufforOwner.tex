...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & -7.41 & 0.15 & 0.08 & -2.02 & 0.33 & 0.66 &  \\ 
  Max & -1.23 & 3.96 & 4.30 & -2.02 & 0.33 & 0.66 &  \\ 
  Mean & -4.65 & 1.04 & 1.19 & -2.02 & 0.33 & 0.66 &  \\ 
  Median & -4.51 & 0.70 & 0.76 & -2.02 & 0.33 & 0.66 &  \\ 
  Stdev & 2.25 & 1.20 & 1.30 & --- & --- & --- &  \\ 
  IQR & 2.76 & 0.17 & 0.26 & 0 & 0 & 0 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Lower middle income & -6.08 & 0.75 & 0.91 & --- & --- & --- &  \\ 
  Upper middle income & -4.48 & 0.59 & 0.69 & --- & --- & --- &  \\ 
  NA & --- & --- & --- & --- & --- & --- &  \\ 
  High income & -2.69 & 0.47 & 0.42 & --- & --- & --- &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:45:40 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & -4.48 & 0.59 & 0.69 & --- & --- & --- &  \\ 
  Europe and Central Asia & -1.23 & 0.15 & 0.08 & --- & --- & --- &  \\ 
  Latin America and Caribbean & -4.15 & 0.80 & 0.75 & --- & --- & --- &  \\ 
  Middle East and North Africa & -4.54 & 0.75 & 1.25 & --- & --- & --- &  \\ 
  South Asia & -7.35 & 0.65 & 0.76 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & -4.07 & 2.38 & 2.60 & --- & --- & --- &  \\ 
  \end{tabular}
