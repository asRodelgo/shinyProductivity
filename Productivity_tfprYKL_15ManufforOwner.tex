...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 1.26 & 0.15 & 0 & 1.12 & 0.12 & 0.15 &  \\ 
  Max & 6.53 & 5.81 & 8.95 & 4.27 & 4.46 & 3.71 &  \\ 
  Mean & 2.71 & 1.11 & 1.6 & 2.36 & 0.88 & 1.07 &  \\ 
  Median & 2.54 & 0.94 & 1.24 & 2.26 & 0.81 & 0.98 &  \\ 
  Stdev & 0.95 & 0.97 & 1.54 & 0.68 & 0.55 & 0.59 &  \\ 
  IQR & 0.98 & 0.74 & 1.13 & 0.65 & 0.34 & 0.6 &  \\ 
  \end{tabular}
