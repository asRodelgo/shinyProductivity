...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & 1.12 & 0.12 & 0.15 & 1.26 & 0.15 & 0.00 &  \\ 
  Max & 4.27 & 4.46 & 3.71 & 6.53 & 5.81 & 8.95 &  \\ 
  Mean & 2.36 & 0.88 & 1.07 & 2.71 & 1.11 & 1.60 &  \\ 
  Median & 2.26 & 0.81 & 0.98 & 2.54 & 0.94 & 1.24 &  \\ 
  Stdev & 0.68 & 0.55 & 0.59 & 0.95 & 0.97 & 1.54 &  \\ 
  IQR & 0.65 & 0.34 & 0.60 & 0.98 & 0.74 & 1.13 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Low income & 3.67 & 0.83 & 0.74 & --- & --- & --- &  \\ 
  Lower middle income & 2.41 & 0.95 & 1.27 & --- & --- & --- &  \\ 
  Upper middle income & 2.15 & 0.74 & 0.88 & --- & --- & --- &  \\ 
  High income & 1.69 & 0.68 & 0.89 & --- & --- & --- &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:43:35 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & 2.29 & 0.94 & 1.08 & --- & --- & --- &  \\ 
  Europe and Central Asia & 1.92 & 0.73 & 0.92 & --- & --- & --- &  \\ 
  Latin America and Caribbean & 2.02 & 0.59 & 0.72 & --- & --- & --- &  \\ 
  Middle East and North Africa & 2.29 & 0.95 & 1.33 & --- & --- & --- &  \\ 
  South Asia & 3.02 & 1.03 & 1.36 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & 2.76 & 0.95 & 1.26 & --- & --- & --- &  \\ 
  \end{tabular}
