...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 0 & 0 & 0 & 0 & 0 & 0 &  \\ 
  Max & 1.2 & 1.27 & 1.69 & 0.58 & 0.54 & 0.57 &  \\ 
  Mean & 0.34 & 0.23 & 0.3 & 0.33 & 0.21 & 0.3 &  \\ 
  Median & 0.36 & 0.22 & 0.29 & 0.35 & 0.21 & 0.29 &  \\ 
  Stdev & 0.19 & 0.17 & 0.23 & 0.13 & 0.09 & 0.13 &  \\ 
  IQR & 0.24 & 0.15 & 0.26 & 0.16 & 0.08 & 0.16 &  \\ 
  \end{tabular}
...
Low income & --- & --- & --- & 0.19 & 0.19 & 0.27 &  \\ 
  ...
  Upper middle income & --- & --- & --- & 0.38 & 0.2 & 0.27 &  \\ 
  High income & --- & --- & --- & 0.4 & 0.22 & 0.31 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:03:40 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & 0.49 & 0.26 & 0.38 & 0.36 & 0.23 & 0.32 &  \\ 
  ...
  Sub-Saharan Africa & --- & --- & --- & 0.19 & 0.2 & 0.28 &  \\ 
  \end{tabular}
