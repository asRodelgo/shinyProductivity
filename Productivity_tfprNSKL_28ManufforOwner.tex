...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & -8.44 & 0.44 & 0.45 & -6.53 & 0.00 & 0.00 &  \\ 
  Max & 6.36 & 1.75 & 3.09 & 6.20 & 1.44 & 2.49 &  \\ 
  Mean & -1.03 & 0.91 & 1.12 & -0.72 & 0.79 & 1.03 &  \\ 
  Median & -0.52 & 0.87 & 1.01 & -0.58 & 0.69 & 0.91 &  \\ 
  Stdev & 4.08 & 0.34 & 0.56 & 4.42 & 0.49 & 0.84 &  \\ 
  IQR & 5.22 & 0.39 & 0.62 & 5.82 & 0.70 & 1.31 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Low income & -5.00 & 1.06 & 1.87 & --- & --- & --- &  \\ 
  Lower middle income & -2.81 & 0.96 & 1.15 & --- & --- & --- &  \\ 
  Upper middle income & -0.58 & 0.88 & 1.09 & --- & --- & --- &  \\ 
  High income & 4.87 & 0.65 & 0.84 & --- & --- & --- &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:45:58 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & -4.51 & 0.96 & 0.92 & --- & --- & --- &  \\ 
  Europe and Central Asia & 4.55 & 0.70 & 0.80 & --- & --- & --- &  \\ 
  Latin America and Caribbean & -0.04 & 0.78 & 0.99 & --- & --- & --- &  \\ 
  Middle East and North Africa & -0.52 & 0.70 & 0.72 & --- & --- & --- &  \\ 
  South Asia & -3.24 & 0.87 & 1.01 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & -1.91 & 1.44 & 1.74 & --- & --- & --- &  \\ 
  \end{tabular}
