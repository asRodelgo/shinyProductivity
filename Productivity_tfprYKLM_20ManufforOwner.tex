...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   ...
   \hline
Min & 1.93 & 0.27 & 0.38 & 0.5 & 0.26 & 0.24 &  \\ 
  Max & 1.93 & 0.27 & 0.38 & 3.05 & 0.78 & 1.15 &  \\ 
  Mean & 1.93 & 0.27 & 0.38 & 2.19 & 0.52 & 0.68 &  \\ 
  Median & 1.93 & 0.27 & 0.38 & 2.4 & 0.51 & 0.74 &  \\ 
  Stdev & --- & --- & --- & 0.66 & 0.16 & 0.3 &  \\ 
  IQR & 0 & 0 & 0 & 0.54 & 0.13 & 0.41 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Local Ownership &   &   & Foreign Ownership &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Low income & --- & --- & --- & 0.5 & 0.64 & 0.89 &  \\ 
  Lower middle income & --- & --- & --- & 2.49 & 0.5 & 0.59 &  \\ 
  Upper middle income & 1.93 & 0.27 & 0.38 & 2.55 & 0.74 & 1.15 &  \\ 
  High income & --- & --- & --- & 2 & 0.48 & 0.79 &  \\ 
  \end{tabular}
...
East Asia and Pacific & --- & --- & --- & 2.77 & 0.42 & 0.42 &  \\ 
  ...
  Sub-Saharan Africa & --- & --- & --- & 0.5 & 0.64 & 0.89 &  \\ 
  \end{tabular}
