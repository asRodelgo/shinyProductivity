...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Min & 0.50 & 0.26 & 0.24 & 1.93 & 0.27 & 0.38 &  \\ 
  Max & 3.05 & 0.78 & 1.15 & 1.93 & 0.27 & 0.38 &  \\ 
  Mean & 2.19 & 0.52 & 0.68 & 1.93 & 0.27 & 0.38 &  \\ 
  Median & 2.40 & 0.51 & 0.74 & 1.93 & 0.27 & 0.38 &  \\ 
  Stdev & 0.66 & 0.16 & 0.30 & --- & --- & --- &  \\ 
  IQR & 0.54 & 0.13 & 0.41 & 0 & 0 & 0 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Low income & 0.50 & 0.64 & 0.89 & --- & --- & --- &  \\ 
  Lower middle income & 2.49 & 0.50 & 0.59 & --- & --- & --- &  \\ 
  Upper middle income & 2.55 & 0.74 & 1.15 & 1.93 & 0.27 & 0.38 &  \\ 
  High income & 2.00 & 0.48 & 0.79 & --- & --- & --- &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Sun May  1 17:44:42 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & median\_Foreign.Ownership & sd\_Foreign.Ownership & iqr\_Foreign.Ownership & median\_Local.Ownership & sd\_Local.Ownership & iqr\_Local.Ownership &  \\ 
  \hline
East Asia and Pacific & 2.77 & 0.42 & 0.42 & --- & --- & --- &  \\ 
  Europe and Central Asia & 2.24 & 0.62 & 0.95 & --- & --- & --- &  \\ 
  Latin America and Caribbean & 2.05 & 0.44 & 0.83 & --- & --- & --- &  \\ 
  Middle East and North Africa & 1.83 & 0.78 & 0.74 & --- & --- & --- &  \\ 
  South Asia & 2.46 & 0.49 & 0.52 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & 0.50 & 0.64 & 0.89 & --- & --- & --- &  \\ 
  \end{tabular}
