...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   ...
   \hline
Min & -5.43 & 0.18 & 0 & -5.14 & 0.04 & 0 &  \\ 
  Max & 2.46 & 1.44 & 2.46 & 3.53 & 1.67 & 2.48 &  \\ 
  Mean & -1.08 & 0.78 & 1.09 & -0.44 & 0.82 & 1.02 &  \\ 
  Median & -0.88 & 0.79 & 1.06 & 0.26 & 0.87 & 0.92 &  \\ 
  Stdev & 2.52 & 0.26 & 0.53 & 2.86 & 0.43 & 0.81 &  \\ 
  IQR & 3.87 & 0.17 & 0.49 & 3.69 & 0.42 & 0.84 &  \\ 
  \end{tabular}
...
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
Low income & -0.8 & 0.89 & 1.45 & --- & --- & --- &  \\ 
  Lower middle income & -0.62 & 0.79 & 1.06 & --- & --- & --- &  \\ 
  Upper middle income & 1.03 & 0.59 & 0.73 & --- & --- & --- &  \\ 
  High income & --- & --- & --- & -0.77 & 0.13 & 0 &  \\ 
  \end{tabular}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon May  2 21:03:06 2016
\begin{tabular}{l>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  &   & Do not export &   &   & Export &   &   \\ 
   & median & sd & IQR & median & sd & IQR &  \\ 
   \hline
East Asia and Pacific & -2.97 & 0.73 & 1.02 & --- & --- & --- &  \\ 
  Europe and Central Asia & -1.61 & 0.73 & 1.29 & -0.77 & 0.13 & 0 &  \\ 
  Latin America and Caribbean & --- & --- & --- & 0.17 & 0.89 & 0.96 &  \\ 
  Middle East and North Africa & -0.41 & 0.84 & 1.06 & --- & --- & --- &  \\ 
  South Asia & -0.8 & 0.88 & 1.1 & --- & --- & --- &  \\ 
  Sub-Saharan Africa & 2.46 & 0.81 & 1.31 & 3.53 & 1.67 & 2.48 &  \\ 
  \end{tabular}
